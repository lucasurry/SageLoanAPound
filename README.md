...
Initially the underwriter will see no data, an applicant will have to make an application which gets approved before they will be able to do anything. The loan engine must be running before any applications will be approved and run to the underwriter.
